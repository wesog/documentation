...
- `d=2008-02-15`: Filter by 15th of February of 2008
- `!d=2008-02-15`: Exclude 15th of February of 2008
- `d=2008-*-*`: Filter by the year 2008
- `d=2008-02-*`: Filter by the month February of 2008  
...
- `<`: Less than date.
- `>`: Greater than date.
- `<=`: Less or equal than date. Aliases: `=<`, `≤`.
- `>=`: Greater or equal than date.  Aliases: `=<`, `≥`.
