...
Filters are the basic block of the query filtering formula, they are defined by the following syntax:
...
#### Filter acronym
Every filter has several ways of name it. For instance, availabel acronyms for the **keyword** filter are: `k`, `key`, `keywords`
...
- Set comparison. 
  ...
  - `⊃`: Subeset. Must contain all of them.
